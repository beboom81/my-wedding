...
export const guest = (() => {
    ...
    const buildGoogleCalendar = () => {
        ...
        const data = new URLSearchParams({
            action: 'TEMPLATE',
            text: 'The Wedding of Duy Khanh và Ý Duyên',
            dates: `${formatDate('2026-10-13 18:00')}/${formatDate('2026-10-13 20:00')}`,
            details: 'Trân trọng kính mời quý khách tham dự lễ thành hôn của Duy Khanh & Ý Duyên. Sự hiện diện của quý khách là niềm vinh dự và hạnh phúc của gia đình chúng tôi.',
            location: '1A Tôn Thất Tùng, Phường Phạm Ngũ Lão, Quận 1, Thành phố Hồ Chí Minh, Việt Nam.',
            ctz: config.get('tz'),
        });
